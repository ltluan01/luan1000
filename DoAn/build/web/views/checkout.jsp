                            ...
                            <c:forEach var="map" items="${myCartItems}">
                                <tr>
                                    ...
                                    <td class="qty text-center">
                                        ...
                                        <input class="input" aria-label="quantity"  type="number" value="${map.value.soLuong}" readonly="true" style="border:none;"/>
                                    </td>
            ...
            <f:form id="checkout-form" class="clearfix" action="muahang.htm" commandName="donHang" method="get">
                <div class="col-md-6">
                    <div class="billing-details">
                        ...
                        <div class="form-group">
                            <f:input class="input" type="text" path="tenKh" placeholder="Họ và tên" value="<%=session.getAttribute("ten")%>" required="required" readonly="true"/>
                        </div>
                        <div class="form-group">
                            <f:input class="input" type="email" path="email" placeholder="Email" value="<%=session.getAttribute("email")%>" required="required" readonly="true"/>
                        </div>
                        <div class="form-group">
                            <f:input class="input" type="text" path="diaChi" placeholder="Địa chỉ" value="<%=session.getAttribute("diachi")%>" required="required" readonly="true"/>
                        </div>
                        <div class="form-group">
                            <f:input class="input" type="text" path="soDienThoai" placeholder="Số điện thoại" value="<%=session.getAttribute("sodienthoai")%>" required="required" readonly="true"/>
                        </div>
                        <% } else { %>
